...
describe GooglePlaces::Spot do
  ...
  context 'Find a single spot' do
    ...
    %w(reference vicinity lat lng name icon types id formatted_phone_number international_phone_number formatted_address address_components street_number street city region postal_code country rating url types website opening_hours).each do |attribute|
